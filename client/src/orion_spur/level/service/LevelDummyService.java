...
public class LevelDummyService implements ILevelService
{
	...
	public List<LevelElement> getLevel(String name)
	{
		...
		result.add(new LevelElement("2", new Vector2(-700, 0), new Vector2(), 20, LayerType.LAYER_1_BEHIND, LevelType.IMAGE, "assets/textures/asteroid-0.png"));
		result.add(new LevelElement("3", new Vector2(0, -1500), new Vector2(), 60, LayerType.LAYER_0_BEHIND, LevelType.IMAGE, "assets/textures/asteroid-0.png"));
		result.add(new LevelElement("4", new Vector2(600, 1000), new Vector2(), 110, LayerType.LAYER_0_BEFORE, LevelType.IMAGE, "assets/textures/asteroid-0.png"));
		result.add(new LevelElement("5", new Vector2(-2000, -500), new Vector2(), 230, LayerType.LAYER_1_BEFORE, LevelType.IMAGE, "assets/textures/asteroid-0.png"));
		return result;
	}
